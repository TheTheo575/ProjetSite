        ...
        <div class="reservation">
            <form method="post" action="#">
                <fieldset>
                    ...
                    <input type="text" name="nom" id="nom" placeholder="Votre nom" /><!--zone de texte a inserer-->
                    ...
                    <input type="time" name="hour" /><!--zone de selection de d'horaire sur une horloge-->
                    <br><br />
                    <label >Numero de téléphone: </label>
                    <input type="tel" name="tel" placeholder="Numéro de téléphone" /><!--zone de texte pour le numéro -->
                    <br><br />
                    <!--<input type="submit" name="Réserver" id="reservation" value="Reserver" />--><!--bouton pour confirmer la réservation-->
                    <a href="confirmation.php" id="reservation">Reserver</a>
                    <br><br />
        ...
        <div class="event">
            <form method="post" action="#" >
                <fieldset><!--zone pour le formulaire-->
                    ...
                    <label >Nom :</label>
                    <input type="text" name="nom"  placeholder="Votre nom" /><!--zone de texte pour le nom-->
                    <br><br />
                    <label >Prénom :</label>
                    <input type="text" name="prenom"  placeholder="votre Prénom" /><!--zone de texte pour le prénom-->
                    <br><br />
                    ...
                    <br><br />
                    <label >Nombre de Personnes: </label>
                    <select class="nbr" name="nbr"><!--zone de selection d'option'-->
                        <option>0</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    <a href="confirmation.php" id="reservation2">Reserver</a>
                    <br><br />
