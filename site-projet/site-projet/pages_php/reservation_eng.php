            ...
            <div class="reservation">
                <form method="post" action="#">
                    <fieldset><!--zone pour mettre un formulare-->
                        ...
                        <label >Name : </label>
                        <input type="text" name="nom" id="nom" placeholder="your name" required/><!--zone de texte pour le nom-->
                        <img src="../images/Assiette.png" alt="LogoAssiette" id="Assiette"> <p style="display:inline;"></p>
                         <br><br />
                        <label >First name : </label>
                         <input type="text" name="prenom" id="prenom" placeholder="your first name" required/><!--zone de texte pour le prénom-->
                        <br><br />
                        ...
                        <input type="date" name=" date" required/><!--zone de selection date avec un calendrier-->
                        <br><br />
                        <label >Hour of the reservation : </label>
                        <input type="time" name="hour" required/><!--zone selection haoraire avec une horloge-->
                        <br><br />
                        <label >Phone number : </label>
                        <input type="tel" name="tel" placeholder="number" required/><!--zone de texte pour le numero de telephone-->
                        <br><br />
                        <!--<input type="submit" name="Réserver" id="reservation" value="Book" />--><!--bouton pour confirmer réservation-->
                        <input type="submit" value="Submit" id="reservation">
                        <br><br />
            ...
            <div class="event">
                <form method="post" action="#" >
                    <fieldset><!--zone début nouveaux formulaire-->
                        ...
                        <label >Name : </label>
                        <input type="text" name="nom"  placeholder="your name" required/><!--zone de texte pour le nom-->
                        <br><br />
                        <label >First name : </label>
                        <input type="text" name="prenom"  placeholder="your first name" required/><!--zone de texte pour le prénom-->
                        <br><br />
                        ...
                        <input type="time" name="hour" required/><!--zone de selection d'horaire avec horloge-->
                        <br><br />
                        ...
                        <select name="event" required><!--zone selection option-->
